...
namespace Skoga
{
    ButtonWidget::ButtonWidget(const Color& backgroundColor)
        : m_BackgroundColor(backgroundColor)
    {
        m_HoverColor = Color(
            m_BackgroundColor.R * 0.85f,
            m_BackgroundColor.G * 0.85f,
            m_BackgroundColor.B * 0.85f,
            m_BackgroundColor.A
        );
    ...
    void ButtonWidget::DrawSelf(NVGcontext* vg)
    {
        ...
        nvgFillColor(vg, nvgRGBA(
            static_cast<unsigned char>(drawColor.R * 255),
            static_cast<unsigned char>(drawColor.G * 255),
            static_cast<unsigned char>(drawColor.B * 255),
            static_cast<unsigned char>(drawColor.A * 255)
        ));
        nvgFill(vg);
    }
} // namespace Skoga
